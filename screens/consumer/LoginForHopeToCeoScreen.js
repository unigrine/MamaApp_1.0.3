...
class LoginForHopeToCeoScreen extends React.Component {
    constructor(props) {
        super(props);
    ...
    async componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.isLoading !== isLoading && !isLoading) {
            ...
            this.props.navigation.navigate('CommentToCeoScreen', {report, shop_id})
        }
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(LoginForHopeToCeoScreen);
