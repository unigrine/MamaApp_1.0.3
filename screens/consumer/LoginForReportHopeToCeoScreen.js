...
class LoginForReportHopeToCeoScreen extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        // console.log('hi LoginForHopeToCeoScreen', appleAuth.isSupported)
    ...
    async componentDidUpdate(prevProps, prevState) {
        ...
        const {report, shop_id} = this.props.route.params
        ...
        if (prevProps.isLoading !== isLoading && !isLoading) {
            ...
            this.props.navigation.navigate('ReportHopeToCeoByCustomerScreen', {report, shop_id})
        }
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(LoginForReportHopeToCeoScreen);
