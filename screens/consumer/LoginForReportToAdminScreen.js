...
class LoginForReportToAdminScreen extends React.Component {
    ...
    async componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.isLoading !== isLoading && !isLoading) {
            ...
            this.props.navigation.navigate('ReportToAdminScreen', {newseventitem, shop_name, shop_id})
        }
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(LoginForReportToAdminScreen);
