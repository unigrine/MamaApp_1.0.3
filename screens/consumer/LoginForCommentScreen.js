...
class LoginForCommentScreen extends React.Component {
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <Header leftIcon="angle-left" title={language.COMMENT_PUT} navigation={this.props.navigation}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(LoginForCommentScreen);
