...
import {ReportHopeToCeoByCustomerAction, ReportHopeToCeoByCustomerSaga} from "../../store/CeoReport/action";

class ReportHopeToCeoByCustomerScreen extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    onPressReport = () => {
        ...
        this.props.ReportHopeToCeoByCustomer(sendData)
    }
    ...
    onPressModalOk() {
        ...
        if (currentscreen === "ShopScreen") {
            this.props.navigation.navigate("ShopScreen", {shop_id, tabselect: 3})  //  뉴스/이벤트 태브로 초기화
        } else
...
const mapDispatchToProps = (dispatch) => {
    return {
        ReportHopeToCeoByCustomer: (data) => dispatch(ReportHopeToCeoByCustomerAction(data)),
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(ReportHopeToCeoByCustomerScreen);
